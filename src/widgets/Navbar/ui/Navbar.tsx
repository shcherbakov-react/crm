                 ...
                 <div className={cls.notification}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            ...
                            stroke="#5F586A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        <path
                            d="M10 3.5C10 4.60457 10.8954 6 12 6C13.1046 6 14 4.60457 14 3.5C14 2.39543 13.1046 2 12 2C10.8954 2 10 2.39543 10 3.5Z"
                            stroke="#5F586A" strokeWidth="2" />
                        <path d="M15 19C15 20.6569 13.6569 22 12 22C10.3431 22 9 20.6569 9 19" stroke="#5F586A"
